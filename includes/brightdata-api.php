...
function brightdata_format_for_analyzer($brightdata_data) {
    ...
    $listing_data = array(
        ...
        'description_by_sections' => isset($listing['description_by_sections']) ? $listing['description_by_sections'] : null,
        ...
        'is_supperhost' => $host_is_superhost,
        'host_about' => '',
        ...
        'ratings' => isset($listing['ratings']) ? floatval($listing['ratings']) : 0,
